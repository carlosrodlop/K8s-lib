...
|-----|------|---------|-------------|
| agents.namespace | string | `"cbci-agents"` | Agents Namespace |
| agents.stress.kubeStresscheckPod | bool | `true` | Deployment of stress pods in the agent namespace |
| controllers.stress.kubeStresscheckPod | bool | `true` | Deployment of stress pods in the applications namespace |
| controllers.stress.loadControllersNumber | int | `3` | Number of Load Controllers for Performance Testing |
